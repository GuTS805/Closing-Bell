  ...
  return (
    <main className="min-h-screen px-5 py-10 sm:py-14">
      <div className="mx-auto w-full max-w-2xl">
        <p className="text-xs text-neutral-500">Step 1 of 2</p>
        <h1 className="mt-1 text-2xl font-semibold tracking-tight">What are you really paying?</h1>
        <p className="mt-1 text-sm text-neutral-400">
          Every number below is live, pulled from Jupiter and Pyth right now.
        </p>
        ...
        <section className="mt-6 rounded-lg border border-neutral-800 bg-neutral-900/40 p-6">
          <p className="text-sm text-neutral-400">
            You are buying <span className="text-neutral-100">{usd(notional)}</span> of{" "}
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          >
            Now watch this get blocked on-chain →
          </Link>
        </div>
      </div>
    </main>
